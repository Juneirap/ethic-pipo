    ...
    <div class="document-table">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td class="border px-4 py-2"
              >5. แบบประเมินโครงการวิจัยด้วยตนเอง (Self-Assessment Form)</td
            >
            <td class="border px-4 py-2">
          ...
          <tr>
            <td class="border px-4 py-2"
              >6. การขัดแย้งทางผลประโยชน์ (Conflict of interest)</td
            >
            <td class="border px-4 py-2">
          ...
          <tr>
            <td class="border px-4 py-2"
              >8. หนังสือแสดงเจตนายินยอมเข้าร่วมการวิจัย (Informed consent form)</td
            >
            <td class="border px-4 py-2">
          ...
          <tr>
            <td class="border px-4 py-2"
              >9. แบบบันทึกข้อมูลสำหรับการวิจัย (Case record form) (ถ้ามี)</td
            >
            <td class="border px-4 py-2">
          ...
          <tr>
            <td class="border px-4 py-2"
              >10. แบบสอบถาม (Questionnaire) (ถ้ามี)</td
            >
            <td class="border px-4 py-2">
