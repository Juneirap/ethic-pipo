const MD5 = function (e: string) {
  ...
  function k(a: number, b: number, c: number, d: number, e: number, f: number, g: number) {
    a = h(a, h(h((b & c) | (~b & d), e), g));
    return h((a << f) | (a >>> (32 - f)), b);
  }

  function l(a: number, b: number, c: number, d: number, e: number, f: number, g: number) {
    a = h(a, h(h((b & d) | (c & ~d), e), g));
    return h((a << f) | (a >>> (32 - f)), b);
  }

  function m(a: number, b: number, d: number, c: number, e: number, f: number, g: number) {
    a = h(a, h(h(b ^ d ^ c, e), g));
    return h((a << f) | (a >>> (32 - f)), b);
  }

  function n(a: number, b: number, d: number, c: number, e: number, f: number, g: number) {
    a = h(a, h(h(d ^ (b | ~c), e), g));
    return h((a << f) | (a >>> (32 - f)), b);
  }
