  ...
  async function getPetitionById() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('Selected values:', { selectedObjective, selectedGrant, selectedType });
      } else {
  ...
  <form>
    <div class="form-row three-col">
      <div class="field">
        ...
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.faculty?.description || ''} readonly/>
        </div>
      </div>
      <div class="field">
        <label>โทรศัพท์</label>
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.faculty?.telNo || ''} readonly />
        </div>
      </div>
      <div class="field">
        <label>ต่อ</label>
    ...
    <div class="form-row two-col">
      <div class="field">
        <label>ชื่อ</label>
        <div class="dotted-line">
          <input type="text" value={`${petitions.researcher?.description || ''}    ${petitions.researcher?.name || ''}`} readonly />
        </div>
      </div>
      <div class="field">
        <label>นามสกุล</label>
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.surname || ''} readonly />
        </div>
      </div>
    </div>
    ...
    <div class="form-row two-col">
      <div class="field">
        <label>อีเมล</label>
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.email || ''} readonly />
        </div>
      </div>
      <div class="field">
        <label>เบอร์โทร</label>
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.telNo || ''} readonly />
        </div>
      </div>
    </div>
    ...
    <div class="form-row two-col">
      <div class="field">
        ...
        <div class="dotted-line">
          <input type="text" value={petitions.researcher?.department?.description || ''} readonly />
        </div>
      </div>
      <div class="field">
      ...
      <table>
        <thead>
          <tr>
            ...
            <th class="border border-gray-300 text-center">ไฟล์ที่อัพโหลด</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>
              1.
              แบบเสนอโครงการวิจัยเพื่อขอรับการพิจารณาจริยธรรมการวิจัยในมนุษย์
            </td>
            <td> แสดงไฟล์ที่userส่งมา </td>
          </tr>
          <tr>
            <td>2. โครงการวิจัยฉบับสมบูรณ์</td>
            <td> แสดงไฟล์ที่userส่งมา </td>
          </tr>
          <tr>
            <td>3. เอกสารการขอความยินยอมการเข้าร่วมโครงการวิจัย (ถ้ามี)</td>
            <td> แสดงไฟล์ที่userส่งมา </td>
          </tr>
          <tr>
            <td>4. แบบบันทึกข้อมูลสำหรับการวิจัย(ถ้ามี)</td>
            <td> แสดงไฟล์ที่userส่งมา </td>
          </tr>
          <tr>
            <td>5. แบบสอบถาม(ถ้ามี)</td>
            <td>แสดงไฟล์ที่userส่งมา</td>
          </tr>
        </tbody>
      </table>
